...
import { VirtualScrollerDefaultOptions } from '../scrollFolder/defaultoptions';
import { IPageInfo } from '../scrollFolder/ipageinfo';
import { IViewport } from '../scrollFolder/iviewport';

import { WrapGroupDimensions } from '../scrollFolder/wrapgroupdimensions';
import { WrapGroupDimension } from '../scrollFolder/wrapgroupdimension';

import { IDimensions } from '../scrollFolder/idimension';
...
@Component({
	selector: 'app-my-virtual-scroll,[virtualScroller]',
	exportAs: 'virtualScroller',
  templateUrl: './my-virtual-scroll.component.html',
  styleUrls: ['./my-virtual-scroll.component.scss'],
	host: {
...
export class MyVirtualScrollComponent implements OnInit, OnChanges, OnDestroy {
    ...
    let options:VirtualScrollerDefaultOptions  = {
      scrollThrottlingTime: 0,
      scrollDebounceTime: 0,
      scrollAnimationTime: 750,
      checkResizeInterval: 1000,
